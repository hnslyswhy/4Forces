...
export async function getAQuestion(id) {
  ...
  let data;
  try {
    response = await axios.get(`${baseUrl}/listeningquestions/${id}`);
    data = response.data;
  } catch (e) {
    console.error(e.message);
  }
...
export async function addAComment(
  ...
  let data;
  try {
    response = await axios.post(`${baseUrl}/resource/${resourceId}/comments`, {
...
export async function getAResourceComments(resourceId) {
  ...
  let data;
  try {
    response = await axios.get(`${baseUrl}/resource/${resourceId}/comments`);
    data = response.data;
  } catch (e) {
    console.error(e.message);
  }
...
export async function getAUserComments(userId) {
  ...
  let data;
  try {
    response = await axios.get(`${baseUrl}/auth/user/${userId}/comments`);
    data = response.data;
  } catch (e) {
    console.error(e.message);
  }
